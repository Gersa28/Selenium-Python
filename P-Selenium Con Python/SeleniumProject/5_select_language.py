...
from selenium.webdriver.support.ui import Select # Clase para manejar listas desplegables, dropdown
import time
...
class LanguageOptions(unittest.TestCase):
    ...
    def test_select_language(self):
        ...
        select_language = Select(self.driver.find_element(By.ID, "select-language")) # Elegir idioma a través del Índice
